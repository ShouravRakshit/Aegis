...
class SEND_MESSAGE(AgentCommand):
    ...
    Attributes:
        agent_id_list (AgentIDList): The list of agents to send a message to. If empty, the message will be sent to all agents in the sender's group.
    ...
    def __init__(self, agent_id_list: AgentIDList, message: str) -> None:
        ...
        Args:
            agent_id_list: The list of agents to send a message to. If empty, the message will be sent to all agents in the sender's group.
